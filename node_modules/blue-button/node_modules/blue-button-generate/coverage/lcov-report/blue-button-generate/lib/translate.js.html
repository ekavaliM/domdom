...
<html lang="en">
<head>
    <title>Code coverage report for blue-button-generate/lib/translate.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button-generate/lib/translate.js</span></h1>
    <h2>
        
        Statements: <span class="metric">97.67% <small>(84 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">97.67% <small>(84 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">blue-button-generate/lib/</a> &#187; translate.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">150</span>
<span class="cline-any cline-yes">16716</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">150</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
var acronymize = exports.acronymize = function (string) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ret === "HA") {
    ...
    var transformPhones = function (input) {
        ...
        if (phones) {
            return phones.reduce(function (r, phone) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (phone &amp;&amp; phone.number) {
                    var attrs = {
    ...
    var transformEmails = function (input) {
        ...
        if (emails) {
            return emails.reduce(function (r, email) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (email &amp;&amp; email.address) {
                    var attrs = {
                        value: "mailto:" + email.address
                    };
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (email.type) {
<span class="cstat-no" title="statement not covered" >                        attrs.use = acronymize(email.type);</span>
                    }
                    r.push(attrs);
                }
                return r;
