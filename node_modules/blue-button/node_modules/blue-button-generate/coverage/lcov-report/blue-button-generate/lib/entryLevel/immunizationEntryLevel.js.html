...
<html lang="en">
<head>
    <title>Code coverage report for blue-button-generate/lib/entryLevel/immunizationEntryLevel.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button-generate/lib/entryLevel/immunizationEntryLevel.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">blue-button-generate/lib/entryLevel/</a> &#187; immunizationEntryLevel.js</div>
</div>
<div class="body">
...
var immunizationMedicationInformation = {
    ...
    dataTransform: function (input) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (input.product) {
...
var immunizationActivityAttributes = function (input) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (input.status) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (input.status === "pending") {
<span class="cstat-no" title="statement not covered" >            return {</span>
                moodCode: "INT",
                negationInd: "false"
            };
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (input.status === "complete") {
            return {
                moodCode: "EVN",
                negationInd: "false"
            };
