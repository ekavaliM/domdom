...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/libxml/cleanup.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/libxml/cleanup.js</span></h1>
    <h2>
        
        Statements: <span class="metric">100% <small>(51 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">89.36% <small>(42 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">blue-button/libxml/</a> &#187; cleanup.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">8065</span>
...
<span class="cline-any cline-yes">7993</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">593</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4506</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1825</span>
    ...
    for (var obj in this.js) {
        if (_.isArray(this.js[obj])) {
            for (var jsobj in this.js[obj]) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isArray(this.js[obj][jsobj].js) === false) {
...
cleanup.extractAllFields = function (flist) { // We need cleanup function to become objects
    var r = function () {
        flist.forEach(function (k) {
            var tmp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js !== undefined &amp;&amp; this.js !== null) {
                tmp = this.js[k];
                delete this.js[k]
            };
            <span class="missing-if-branch" title="else path not taken" >E</span>if (tmp) { //HACK: added this if
                <span class="missing-if-branch" title="else path not taken" >E</span>if (tmp.js) {
                    Object.keys(tmp.js).forEach(function (m) {
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js[m] === undefined) {
                            this.js[m] = tmp.js[m];
                        }
                    }, this);
                }
