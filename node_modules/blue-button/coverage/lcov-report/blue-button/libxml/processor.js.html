...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/libxml/processor.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/libxml/processor.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">blue-button/libxml/</a> &#187; processor.js</div>
</div>
<div class="body">
...
&nbsp;
    if (v.text) {
        ...
        //     ret = v.text;
        // }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof v.text === "function") {
            ret = v.text();
        }
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (v.value) { // attribute
        // if (typeof v.value === "string") {
        //     ret = v.value;
        // }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof v.value === "function") {
            ret = v.value();
        }
