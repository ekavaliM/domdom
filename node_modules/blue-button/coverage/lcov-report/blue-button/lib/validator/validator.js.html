...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/validator/validator.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">blue-button/lib/validator/validator.js</span></h1>
    <h2>
        
        Statements: <span class="metric">68.21% <small>(103 / 151)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">68.21% <small>(103 / 151)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/validator/</a> &#187; validator.js</div>
</div>
<div class="body">
...
&nbsp;
    this.getSectionDocumentModel = <span class="fstat-no" title="function not covered" >function (sectionName) {</span>
<span class="cstat-no" title="statement not covered" >        if (sectionName in keySchemaMap) {</span>
<span class="cstat-no" title="statement not covered" >            var sectionSchema = keySchemaMap[sectionName];</span>
<span class="cstat-no" title="statement not covered" >            var compiledSchema = validator.compileSchema(sectionSchema);</span>
<span class="cstat-no" title="statement not covered" >            lastError = validator.getLastError();</span>
<span class="cstat-no" title="statement not covered" >            return compiledSchema;</span>
        }
<span class="cstat-no" title="statement not covered" >        return {}</span>
&nbsp;
    }
&nbsp;
    this.getDocumentModel = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        var compiledSchema = validator.compileSchema(documentModelSchema);</span>
<span class="cstat-no" title="statement not covered" >        lastError = validator.getLastError();</span>
<span class="cstat-no" title="statement not covered" >        return compiledSchema;</span>
    }
&nbsp;
...
&nbsp;
    this.validateSectionObj = <span class="fstat-no" title="function not covered" >function validateSectionObj(sectionObj, sectionName) {</span>
<span class="cstat-no" title="statement not covered" >        if (sectionName in keySchemaMap) {</span>
<span class="cstat-no" title="statement not covered" >            var sectionSchema = keySchemaMap[sectionName];</span>
<span class="cstat-no" title="statement not covered" >            compiledSchema = validator.compileSchema(sectionSchema);</span>
<span class="cstat-no" title="statement not covered" >            var valid = validator.validate(sectionObj, compiledSchema);</span>
<span class="cstat-no" title="statement not covered" >            lastError = validator.getLastError();</span>
<span class="cstat-no" title="statement not covered" >            return valid;</span>
        }
<span class="cstat-no" title="statement not covered" >        var sharedSchema = validator.compileSchema(keySchemaMap.shared);</span>
<span class="cstat-no" title="statement not covered" >        var sharedModels = sharedSchema['__$refResolved'].properties; </span>//nevermind, use an alternative approach
<span class="cstat-no" title="statement not covered" >        if (sectionName in sharedModels) {</span>
<span class="cstat-no" title="statement not covered" >            var sharedObjects = {};</span>
<span class="cstat-no" title="statement not covered" >            sharedObjects[sectionName] = sectionObj;</span>
<span class="cstat-no" title="statement not covered" >            var valid = validator.validate(sharedObjects, sharedSchema);</span>
<span class="cstat-no" title="statement not covered" >            lastError = validator.getLastError();</span>
<span class="cstat-no" title="statement not covered" >            return valid;</span>
        }
<span class="cstat-no" title="statement not covered" >        return false;</span>
    }
    this.getLastError = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return lastError;</span>
    }
&nbsp;
    this.validateSection = <span class="fstat-no" title="function not covered" >function validateSection(section, sectionName) {</span>
        /*not sure about triple equals here because object strings and primitive
        string =S */
<span class="cstat-no" title="statement not covered" >        if (sectionName.toLowerCase() === 'demographics' || sectionName.toLowerCase() === 'social history') {</span>
<span class="cstat-no" title="statement not covered" >            var sectionSchema = keySchemaMap[sectionName];</span>
<span class="cstat-no" title="statement not covered" >            compiledSchema = validator.compileSchema(sectionSchema);</span>
<span class="cstat-no" title="statement not covered" >            var valid = validator.validate(sectionObj, compiledSchema);</span>
<span class="cstat-no" title="statement not covered" >            lastError = validator.getLastError();</span>
<span class="cstat-no" title="statement not covered" >            return valid;</span>
        } else <span class="cstat-no" title="statement not covered" >if (sectionName in keySchemaMap) {</span>
<span class="cstat-no" title="statement not covered" >            var sectionSchema = keySchemaMap[sectionName];</span>
<span class="cstat-no" title="statement not covered" >            compiledSchema = validator.compileSchema(sectionSchema);</span>
<span class="cstat-no" title="statement not covered" >            for (var x in section) {</span>
<span class="cstat-no" title="statement not covered" >                var valid = validator.validate(section[x], compiledSchema);</span>
...
<span class="cstat-no" title="statement not covered" >        if (sectionName in sharedModels) {</span>
<span class="cstat-no" title="statement not covered" >            var sharedObjects = {};</span>
<span class="cstat-no" title="statement not covered" >            sharedObjects[sectionName] = section;</span>
<span class="cstat-no" title="statement not covered" >            var valid = validator.validate(sharedObjects, sharedSchema);</span>
<span class="cstat-no" title="statement not covered" >            lastError = validator.getLastError();</span>
<span class="cstat-no" title="statement not covered" >            return valid;</span>
        }
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Oct 28 2014 09:32:21 GMT-0400 (EDT)</div>
</div>
