...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser.js</span></h1>
    <h2>
        
        Statements: <span class="metric">81.48% <small>(44 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">69.44% <small>(25 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/</a> &#187; parser.js</div>
</div>
<div class="body">
...
function sections(data) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!data.meta) {
<span class="cstat-no" title="statement not covered" >        data.meta = {};</span>
    }
&nbsp;
...
function parseText(txt) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!txt || typeof (txt) !== "string") {
...
function parseXml(doc, options, sensed) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!doc || typeof (doc) !== "object") {
        //TODO: throw a proper error here
<span class="cstat-no" title="statement not covered" >        return null;</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!componentParser) {
<span class="cstat-no" title="statement not covered" >        var msg = util.format("Component %s is not supported.", options.component);</span>
...
function parseString(data, options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!data || typeof (data) !== "string") {
        //TODO: throw a proper error here
<span class="cstat-no" title="statement not covered" >        return null;</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (sensed) {
        if (sensed.xml) {
            return parseXml(sensed.xml, options, sensed);
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (sensed.json) {
<span class="cstat-no" title="statement not covered" >            return sensed.json;</span>
        } else {
