...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/generator/ccda/templates/vitals.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/generator/ccda/templates/vitals.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/generator/ccda/templates/</a> &#187; vitals.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    var xmlDoc = libCCDAGen.header(!isCCD ? <span class="branch-0 cbranch-no" title="branch not covered" >doc </span>: CCDxml, "2.16.840.1.113883.10.20.22.2.4", "2.16.840.1.113883.10.20.22.2.4.1", "8716-3",
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (data[0].status) {
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (data[j].status) {
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (data[j]["unit"]) {
...
<span class="cstat-no" title="statement not covered" >                xmlDoc = xmlDoc.node('value')</span>
                    .attr({
                        "xsi:type": "PQ"
                    })
                    .attr({
