...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/generator/ccda/generator.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/generator/ccda/generator.js</span></h1>
    <h2>
        
        Statements: <span class="metric">100% <small>(53 / 53)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">94.12% <small>(32 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/generator/ccda/</a> &#187; generator.js</div>
</div>
<div class="body">
...
var gen = function (data, CCD, xmlDoc, section_name) {
    if (data) {
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (section_name == "vitals") {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (count_sections &gt; 0) {
