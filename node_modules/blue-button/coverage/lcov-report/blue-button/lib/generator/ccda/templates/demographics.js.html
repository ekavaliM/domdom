...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/generator/ccda/templates/demographics.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/generator/ccda/templates/demographics.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/generator/ccda/templates/</a> &#187; demographics.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">8</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var libxmljs = require("libxmljs");
var libCCDAGen = require("../lib/templating_functions.js");
&nbsp;
module.exports = function (data, codeSystems, isCCD, xmlDoc) {
    var dob = libCCDAGen.getTimes(data["dob"]);
    var doc = new libxmljs.Document();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isCCD) {
<span class="cstat-no" title="statement not covered" >        var xmlDoc = doc.node('ClinicalDocument').attr({"xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance"})</span>
                .attr({xmlns: "urn:hl7-org:v3"})
                .attr({"xmlns:cda": "urn:hl7-org:v3"})
&nbsp;
                .attr({"xmlns:sdtc": "urn:hl7-org:sdtc"});
<span class="cstat-no" title="statement not covered" >            if (data["identifiers"]) {</span>
<span class="cstat-no" title="statement not covered" >                xmlDoc = libCCDAGen.id(xmlDoc, data["identifiers"]);    </span>
<span class="cstat-no" title="statement not covered" >                xmlDoc = xmlDoc.node('id')</span>
    ...
    if (data.guardians) {
        xmlDoc = xmlDoc.node('guardian');
            xmlDoc = libCCDAGen.code(xmlDoc, 
                libCCDAGen.reverseTable("2.16.840.1.113883.5.111", data.guardians ? data.guardians[0].relation : <span class="branch-1 cbranch-no" title="branch not covered" >undefined)</span>).parent();
...
&nbsp;
    ...
    //     .parent()
    // .parent();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!xmlDoc) {
<span class="cstat-no" title="statement not covered" >        xmlDoc = xmlDoc.parent();</span>
    }
&nbsp;
    return isCCD ? xmlDoc : <span class="branch-1 cbranch-no" title="branch not covered" >doc;</span>
}
&nbsp;</pre></td></tr>
</table></pre>
