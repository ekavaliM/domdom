...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/generator/ccda/templates/results.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/generator/ccda/templates/results.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/generator/ccda/templates/</a> &#187; results.js</div>
</div>
<div class="body">
...
&nbsp;
                    ...
                    .node('interpretationCode')
                        .attr(results["interpretations"] ? 
                            {code: results["interpretations"][0].substr(0, 1)} : <span class="branch-1 cbranch-no" title="branch not covered" >{nullFlavor: "UNK"})</span>
...
module.exports = function (data, codeSystems, isCCD, CCDxml) {
    ...
    var xmlDoc = libCCDAGen.header_v2(!isCCD ? <span class="branch-0 cbranch-no" title="branch not covered" >doc </span>: CCDxml, "2.16.840.1.113883.10.20.22.2.3", 
