...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/generator/ccda/templates/procedures.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/generator/ccda/templates/procedures.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/generator/ccda/templates/</a> &#187; procedures.js</div>
</div>
<div class="body">
...
module.exports = function (data, codeSystems, isCCD, CCDxml) {
    ...
    var xmlDoc = libCCDAGen.header_v2(!isCCD ? <span class="branch-0 cbranch-no" title="branch not covered" >doc </span>: CCDxml, "2.16.840.1.113883.10.20.22.2.7", "2.16.840.1.113883.10.20.22.2.7.1", 
...
&nbsp;
                    if (data[i].locations) {
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (data[i].locations[0]["location_type"]) {
