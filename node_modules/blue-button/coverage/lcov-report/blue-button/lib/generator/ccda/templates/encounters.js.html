...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/generator/ccda/templates/encounters.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/generator/ccda/templates/encounters.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/generator/ccda/templates/</a> &#187; encounters.js</div>
</div>
<div class="body">
...
module.exports = function (data, codeSystems, isCCD, CCDxml) {
    ...
    var xmlDoc = libCCDAGen.header(!isCCD ? <span class="branch-0 cbranch-no" title="branch not covered" >doc </span>: CCDxml, "2.16.840.1.113883.10.20.22.2.22", "2.16.840.1.113883.10.20.22.2.22.1",
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (dEncounter) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (dPerformers) {
...
&nbsp;
        ...
        if (data[i]["findings"]) {
            if (data[i]["findings"][0]["date_time"]) {
                 xmlDoc = libCCDAGen.indicationConstraint(xmlDoc, data[i]["findings"], libCCDAGen.getTimes(data[i]["findings"] ? data[i]["findings"][0]["date_time"] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined)</span>);
            }
        }
