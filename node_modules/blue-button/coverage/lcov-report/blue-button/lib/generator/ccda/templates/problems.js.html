...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/generator/ccda/templates/problems.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/generator/ccda/templates/problems.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/generator/ccda/templates/</a> &#187; problems.js</div>
</div>
<div class="body">
...
module.exports = function (data, codeSystems, isCCD, CCDxml) {
    ...
    var xmlDoc = libCCDAGen.header(!isCCD ? <span class="branch-0 cbranch-no" title="branch not covered" >doc </span>: CCDxml, "2.16.840.1.113883.10.20.22.2.5", "2.16.840.1.113883.10.20.22.2.5.1", "11450-4",
            ...
            .node('act').attr({classCode: "ACT"})
                ...
                xmlDoc = xmlDoc.node('entryRelationship').attr({typeCode: "SUBJ"})
                    .node('observation').attr({classCode: "OBS"}).attr({moodCode: "EVN"}) //problem observation
                        ...
                        xmlDoc = libCCDAGen.effectiveTime(xmlDoc, libCCDAGen.getTimes(data[i]["problem"] ? data[i]["problem"]["date_time"] : <span class="branch-1 cbranch-no" title="branch not covered" >time)</span>);
