...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cda/shared.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cda/shared.js</span></h1>
    <h2>
        
        Statements: <span class="metric">89.47% <small>(34 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cda/</a> &#187; shared.js</div>
</div>
<div class="body">
...
NegationIndicator.fields([
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.js) {
<span class="cstat-no" title="statement not covered" >            if (!common.exists(this.js)) {</span>
<span class="cstat-no" title="statement not covered" >                this.js.negation_indicator = false;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (this.js.negation_indicator === 'true') {</span>
<span class="cstat-no" title="statement not covered" >                this.js.negation_indicator = true;</span>
            }
        } else {
            this.js = {
