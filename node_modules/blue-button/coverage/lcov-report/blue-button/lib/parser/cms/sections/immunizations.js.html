...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/sections/immunizations.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/sections/immunizations.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/sections/</a> &#187; immunizations.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  parser, store them in an intermediary object.*/
    ...
    for (var x in sectionObj) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(child).length &gt; 1) { //get the dates for each object
...
function getImmunObj(child, dateKey, dateObj) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (dateObj !== undefined) {
        dateArray["point"] = dateObj;
        returnObj.status = 'complete';
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (administration !== undefined) {
        returnObj.administration = administration;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (product !== undefined) {
        returnObj.product = product;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (dateArray != {}) {
...
function getAdministration(child) {
    ...
    var parseCodedEntry = commonFunctions.getFunction(
        'cda_coded_entry');
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if ('method' in child) {
...
function getDates(child) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if ('date administered' in child) {
