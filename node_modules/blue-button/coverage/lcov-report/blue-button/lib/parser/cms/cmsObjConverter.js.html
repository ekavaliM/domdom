...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/cmsObjConverter.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/cmsObjConverter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/</a> &#187; cmsObjConverter.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">//converts CMS Object to the BB.js
&nbsp;
...
function putDataInBBModel(key, parsedSection, bbDocumentModel) {
    ...
    if (key in bbDocumentModel) {
        if (bbDocumentModel[key] instanceof Array) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (parsedSection instanceof Array) {
                for (var x in parsedSection) {
                    bbDocumentModel[key].push(parsedSection[x]);
                }
            } else {
<span class="cstat-no" title="statement not covered" >                bbDocumentModel[key].push(parsedSection);</span>
            }
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof bbDocumentModel[key] == 'object') {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (parsedSection instanceof Array) {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if ('data' in bbDocumentModel) {
