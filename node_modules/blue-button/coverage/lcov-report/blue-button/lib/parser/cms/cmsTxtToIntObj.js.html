...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/cmsTxtToIntObj.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/cmsTxtToIntObj.js</span></h1>
    <h2>
        
        Statements: <span class="metric">91.39% <small>(244 / 267)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">91.39% <small>(244 / 267)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/</a> &#187; cmsTxtToIntObj.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">//Byung Joo Shin, Amida Tech
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (cmsString.indexOf('\r\n') &gt;= 0) {
<span class="cstat-no" title="statement not covered" >        cmsString = cmsString.replace(/\r\n/g, '\n');</span>
<span class="cstat-no" title="statement not covered" >        cmsString = cmsString.replace(/\r/g, '\n');</span>
        //cmsString=cmsString.replace(/\n\n/g, '\n');
<span class="cstat-no" title="statement not covered" >        return cmsString;</span>
    }
&nbsp;
    return cmsString;
}
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getTitles(fileString) {</span>
<span class="cstat-no" title="statement not covered" >    var headerMatchCode = '(-){4,}[\\S\\s]+?(\\n){2,}(-){4,}';</span>
<span class="cstat-no" title="statement not covered" >    var headerRegExp = new RegExp(headerMatchCode, 'gi');</span>
<span class="cstat-no" title="statement not covered" >    var rawTitleArray = fileString.match(headerRegExp);</span>
<span class="cstat-no" title="statement not covered" >    var titleArray = [];</span>
<span class="cstat-no" title="statement not covered" >    if (rawTitleArray === null)</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, len = rawTitleArray.length; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >        var tempTitle = cleanUpTitle(rawTitleArray[i]);</span>
        //exception to the rule, claim lines
<span class="cstat-no" title="statement not covered" >        if (tempTitle.toLowerCase().indexOf("claim lines for claim number") &lt; 0 &amp;&amp;</span>
            tempTitle.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >            titleArray[i] = tempTitle;</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    return titleArray;</span>
}
&nbsp;
...
&nbsp;
    ...
    while (rawTitleString.charAt(dashBegIndex) == (dashChar || <span class="branch-1 cbranch-no" title="branch not covered" >'\n')</span>) {
        dashBegIndex++;
    }
    while (rawTitleString.charAt(dashEndIndex) == (dashChar || <span class="branch-1 cbranch-no" title="branch not covered" >'\n')</span>) {
        dashEndIndex--;
    }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!isEmpty(sectionChild)) {
...
&nbsp;
    ...
    for (var obj in claimStrings) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!isEmpty(child)) {
    ...
    for (var obj in claimLineStrings) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!isEmpty(sectionChild)) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if ('source' in sectionChild) {
<span class="cstat-no" title="statement not covered" >                sectionBody.source = sectionChild.source;</span>
            } else {
                var claimNumber = sectionChild.claimNumber;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (claimsLineChildren[claimNumber] !== undefined) {
<span class="cstat-no" title="statement not covered" >                    for (var x = 0; x &lt; sectionChild.data.length; x++) {</span>
<span class="cstat-no" title="statement not covered" >                        claimsLineChildren[claimNumber].push(sectionChild.data[x]);</span>
                    }
                } else {
...
&nbsp;
    ...
    for (var x in claimsChildren) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (x in claimsLineChildren) {
...
&nbsp;
  ...
  one child of a section*/
    ...
    for (var s in keyValuePairArray) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (key.length &lt;= 0) {
...
<span class="cstat-no" title="statement not covered" >            objArray.push(obj);</span>
<span class="cstat-no" title="statement not covered" >            obj = {};</span>
        }
        obj[key] = value;
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (objArray.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >        objArray.push(obj);</span>
<span class="cstat-no" title="statement not covered" >        return objArray;</span>
    } else {
        return obj;
    }
}
