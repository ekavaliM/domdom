...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/sections/allergies.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/sections/allergies.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/sections/</a> &#187; allergies.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(dateArray).length &gt; 0) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (returnChildObj["observation"].status === undefined) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if ('reaction' in childObj) {
        var reactionName = childObj.reaction;
        reactionObj.reaction = parseCodedEntry(reactionName);
        delete childObj.reaction;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if ('severity' in childObj) {
&nbsp;
        var severityVal = childObj['severity'].toLowerCase();
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (severityVal in severityDict) {
            reactionObj.severity = {};
            reactionObj.severity.code = severityDict[severityVal];
        } else {
<span class="cstat-no" title="statement not covered" >            reactionObj.severity = {};</span>
<span class="cstat-no" title="statement not covered" >            reactionObj.severity.code = parseCodedEntry(severityVal);</span>
        }
