...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/sections/vitals.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/sections/vitals.js</span></h1>
    <h2>
        
        Statements: <span class="metric">85% <small>(51 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">85% <small>(51 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/sections/</a> &#187; vitals.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    for (var key in sectionObj) {
        ...
        var childObj = {};
        <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(rawChild).length &gt; 1) {
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (command === 'diastolic') {
        childObj.vital = codeDict["blood pressure diastolic"];
    } else <span class="cstat-no" title="statement not covered" >if (command === 'weight') {</span>
<span class="cstat-no" title="statement not covered" >        childObj.vital = codeDict["weight"];</span>
    } else <span class="cstat-no" title="statement not covered" >if (command === 'height') {</span>
<span class="cstat-no" title="statement not covered" >        childObj.vital = codeDict["height"];</span>
    }
&nbsp;
}
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (date !== null || <span class="branch-1 cbranch-no" title="branch not covered" >date !== undefined)</span> {
...
function getVitalUnits(vitalType) {
    ...
    if (vitalType.toLowerCase() == 'blood pressure') {
        return 'mm[Hg]';
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (vitalType.toLowerCase().indexOf('glucose') &gt;= 0) {
        return 'mg/dL';
    } else <span class="cstat-no" title="statement not covered" >if (vitalType.toLowerCase().indexOf('height') &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >        return 'cm';</span>
    } else <span class="cstat-no" title="statement not covered" >if (vitalType.toLowerCase().indexOf('weight') &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >        return 'kg';</span>
    }
&nbsp;
