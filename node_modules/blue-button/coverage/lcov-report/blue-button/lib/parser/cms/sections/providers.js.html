...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/sections/providers.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/sections/providers.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/sections/</a> &#187; providers.js</div>
</div>
<div class="body">
...
&nbsp;
        ...
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (key.indexOf('specialty') &gt;= 0) {
&nbsp;
...
&nbsp;
        ...
        else <span class="cstat-no" title="statement not covered" >if (key.indexOf('medicare provider') &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >            var organization = {};</span>
<span class="cstat-no" title="statement not covered" >            organization.name = value;</span>
<span class="cstat-no" title="statement not covered" >            childObj.organization = organization;</span>
        }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        childObj.date_time = dateArray;</span>
    }
    return childObj;
}
&nbsp;
