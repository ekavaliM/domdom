...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/sections/claims.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/sections/claims.js</span></h1>
    <h2>
        
        Statements: <span class="metric">92.53% <small>(260 / 281)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">87.05% <small>(195 / 224)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(8 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">92.53% <small>(260 / 281)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/sections/</a> &#187; claims.js</div>
</div>
<div class="body">
...
function isClaimTypeD(childObj) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ignoreValue(claimLineArr)) {
<span class="cstat-no" title="statement not covered" >        return false;</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (claimLineArr.length &gt; 0) {
        var claimLine = claimLineArr[0];
        if (claimLine['claim type'] === undefined) {
            return false;
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (claimLine['claim type'].toLowerCase().indexOf('part d') &gt;= 0) {
            return true;
        }
    }
<span class="cstat-no" title="statement not covered" >    return false;</span>
...
&nbsp;
    ...
    */
    ...
    for (var key in childObj) {
        ...
        key = key.toLowerCase();
        <span class="missing-if-branch" title="if path not taken" >I</span>if (ignoreValue(value)) {
<span class="cstat-no" title="statement not covered" >            continue;</span>
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!claimLineObj.date_time) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(prescriberObj).length &gt; 0) {
        performerArray.push(prescriberObj);
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(pharmacyObj).length &gt; 0) {
        performerArray.push(pharmacyObj);
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(drugObj).length &gt; 0) {
        claimLineObj.drug = drugObj;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (performerArray.length &gt; 0) {
...
&nbsp;
    for (var key in childObj) {
        ...
        if (key.indexOf('claim number') &gt;= 0) {
            ...
            var processDate = commonFunctions.getFunction('cda_date');
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!returnChildObj.date_time) {
                returnChildObj.date_time = {};
            };
            returnChildObj.date_time["low"] = processDate(value);
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (key.indexOf('service end date') &gt;= 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >value.length &gt;= 0)</span> {
<span class="cstat-no" title="statement not covered" >            var processDate = commonFunctions.getFunction('cda_date');</span>
<span class="cstat-no" title="statement not covered" >            if (!returnChildObj.date_time) {</span>
<span class="cstat-no" title="statement not covered" >                returnChildObj.date_time = {};</span>
            };
<span class="cstat-no" title="statement not covered" >            returnChildObj.date_time["high"] = processDate(value);</span>
        ...
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (key.indexOf('revenue code') &gt;= 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >value.length &gt;= 0)</span> {
<span class="cstat-no" title="statement not covered" >            var revenueValueArray = value.split('-');</span>
<span class="cstat-no" title="statement not covered" >            revenueObj.code = revenueValueArray[0].trim();</span>
<span class="cstat-no" title="statement not covered" >            revenueObj.description = revenueValueArray[1].trim();</span>
<span class="cstat-no" title="statement not covered" >            claimLineObj.procedure = procedureObj;</span>
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (key.indexOf('provider billing address') &gt;= 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >value.length &gt;= 0)</span> {
<span class="cstat-no" title="statement not covered" >            var processAddress = commonFunctions.getFunction('cda_line_address');</span>
<span class="cstat-no" title="statement not covered" >            performerObj.address = [processAddress(value)];</span>
            //these few commands are for claim line type d
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (key === 'provider' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >value.length &gt;= 0)</span> {
<span class="cstat-no" title="statement not covered" >            performerObj.name = [value];</span>
        }
    }
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(performerObj).length &gt; 0) {
<span class="cstat-no" title="statement not covered" >        returnChildObj.performer = [performerObj];</span>
    }
...
function extrapolateDatesFromLines(claimLines, returnChildObj) {
    ...
    if (returnChildObj.date_time) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (returnChildObj.date_time.high) {
<span class="cstat-no" title="statement not covered" >            highTime = returnChildObj.date_time.high;</span>
        }
    ...
    for (var x in claimLines) {
        ...
        if (claimLineObj.date_time) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (claimLineObj.date_time.point &amp;&amp; pointTime === undefined) {
<span class="cstat-no" title="statement not covered" >                pointTime = claimLineObj.date_time.point;</span>
            }
            ...
            if (lowTime !== undefined &amp;&amp; claimLineObj.date_time.low) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (lineLowDateTime &lt; lowDateTime) {
<span class="cstat-no" title="statement not covered" >                    lowTime = claimLineObj.date_time.low;</span>
                }
            }
            if (highTime !== undefined &amp;&amp; claimLineObj.date_time.high) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (lineHighDateTime &gt; highDateTime) {
<span class="cstat-no" title="statement not covered" >                    highTime = claimLineObj.date_time.high;</span>
                }
            }
            ...
            if (pointTime !== undefined &amp;&amp; claimLineObj.date_time.point) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (pointDateTime &gt; pointDateTime) {
<span class="cstat-no" title="statement not covered" >                    pointTime = claimLineObj.date_time.point;</span>
                }
            }
        }
...
&nbsp;
    ...
    for (var key in claimLines) {
        ...
        if (ignoreValue(value)) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!claimLineObj.date_time) {
<span class="cstat-no" title="statement not covered" >                claimLineObj.date_time = {};</span>
            };
