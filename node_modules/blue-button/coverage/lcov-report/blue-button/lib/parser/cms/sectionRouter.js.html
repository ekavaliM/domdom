...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/sectionRouter.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/sectionRouter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/</a> &#187; sectionRouter.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js"> var commonFunctions = require('./sections/commonFunctions');
&nbsp;
 var sections = {
     'meta': getMeta,
...
&nbsp;
 var sectionRouter = function (sectionName) {
     if (sectionName in sections) {
         <span class="missing-if-branch" title="else path not taken" >E</span>if (sections[sectionName] !== null) {
