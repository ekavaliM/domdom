...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/cms/sections/demographics.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/cms/sections/demographics.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/cms/sections/</a> &#187; demographics.js</div>
</div>
<div class="body">
...
&nbsp;
    for (key in intObj) {
        ...
        if (ignoreValue(value)) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (value.length &gt;= 1) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (emailArray.length &gt; 0) {
        result.email = emailArray;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (phoneArray.length &gt; 0) {
        result.phone = phoneArray;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(addressObj).length &gt; 2) {
