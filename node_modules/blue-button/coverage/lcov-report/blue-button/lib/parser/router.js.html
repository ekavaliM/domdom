...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/router.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/router.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/</a> &#187; router.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">//CCDA to JSON parser.
&nbsp;
"use strict";
&nbsp;
var generateComponents = function (version) {
&nbsp;
    version = version.indexOf("-") &gt; -1 ? <span class="branch-0 cbranch-no" title="branch not covered" >"_" + version.split("-")[1] </span>: "";
&nbsp;
    return {
&nbsp;
        //Base CCD Object.
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (componentName) {
<span class="cstat-no" title="statement not covered" >        return generateComponents(type["type"])[componentName];</span>
    } else {
&nbsp;
        if (type["type"] === 'c32') {
