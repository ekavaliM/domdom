...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/ccda/demographics.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/ccda/demographics.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/ccda/</a> &#187; demographics.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js &amp;&amp; (this.js.ethnicity || <span class="branch-2 cbranch-no" title="branch not covered" >this.js.race)</span>) { //HACK: addded if
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.js.ethnicity &amp;&amp; (this.js.ethnicity.js.code === "2135-2")) {
<span class="cstat-no" title="statement not covered" >            this.js = this.js.ethnicity.js.name;</span>
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js.race) { //FIX: if race is nullFlavor fallback to ethnicity
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js.race.js.code) {
