...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/ccda/sections/immunizations.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/ccda/sections/immunizations.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/ccda/sections/</a> &#187; immunizations.js</div>
</div>
<div class="body">
...
var augmentImmunizationStatus = function () {
    ...
    if (this.js.negation_ind === "true") {
        tmpStatus = "refused";
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.js.mood_code === "INT") {
<span class="cstat-no" title="statement not covered" >        tmpStatus = "pending";</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js.mood_code === "EVN") {
        tmpStatus = "complete";
    } else {
<span class="cstat-no" title="statement not covered" >        tmpStatus = "unknown";</span>
    }
    this.js = tmpStatus;
};
&nbsp;
...
&nbsp;
    var ImmunizationActivity = component.define("ImmunizationActivity")
        ...
        .fields([
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js) { // Refusal reason should use the template id
                <span class="missing-if-branch" title="if path not taken" >I</span>if (this.js.refusal_reason &amp;&amp; (!this.js.refusal_reason.js)) {
<span class="cstat-no" title="statement not covered" >                    delete this.js.refusal_reason;</span>
                }
            }
        });
&nbsp;
