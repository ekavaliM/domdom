...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/ccda/sections/medications.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/ccda/sections/medications.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/ccda/sections/</a> &#187; medications.js</div>
</div>
<div class="body">
...
&nbsp;
    var author = component.define("author")
        .fields([
            ...
            [version === "" ? "name" : <span class="branch-1 cbranch-no" title="branch not covered" >"organization",</span> "0..1",
                "(h:assignedAuthor/h:representedOrganization | h:assignedAuthor/h:assignedPerson/h:name)[last()]", (version === "" ? shared.IndividualName : <span class="branch-1 cbranch-no" title="branch not covered" >shared.Organization)</span>
            ]
        ]);
&nbsp;
...
&nbsp;
                //Cleanup Status.
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js.status === "EVN") {
                    this.js.status = "Completed";
                }
                <span class="missing-if-branch" title="if path not taken" >I</span>if (this.js.status === "INT") {
<span class="cstat-no" title="statement not covered" >                    this.js.status = "Prescribed";</span>
                }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        medicationInformation = component.define("medicationInformation")</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        medicationSupplyOrder = component.define("medicationSupplyOrder")</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        medicationActivity = component.define("Medications")</span>
            ...
            .cleanupStep(<span class="fstat-no" title="function not covered" >function () {</span>
&nbsp;
                //Cleanup Status.
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (this.js.status === "EVN") {</span>
<span class="cstat-no" title="statement not covered" >                    this.js.status = "Completed";</span>
                }
<span class="cstat-no" title="statement not covered" >                if (this.js.status === "INT") {</span>
<span class="cstat-no" title="statement not covered" >                    this.js.status = "Prescribed";</span>
                }
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >        medicationsSection = component.define("medicationsSection");</span>
<span class="cstat-no" title="statement not covered" >        medicationsSection.templateRoot("2.16.840.1.113883.10.20.1.8");</span>
<span class="cstat-no" title="statement not covered" >        medicationsSection.fields([</span>
            ["Medications", "0..*", medicationActivity.xpath(), medicationActivity]
        ]);
<span class="cstat-no" title="statement not covered" >        medicationsSection.cleanupStep(cleanup.replaceWithField('medications'));</span>
<span class="cstat-no" title="statement not covered" >        return [medicationsSection, medicationActivity];</span>
    }
};
&nbsp;
