...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/c32/sections/immunizations.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/c32/sections/immunizations.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/c32/sections/</a> &#187; immunizations.js</div>
</div>
<div class="body">
...
var augmentImmunizationStatus = function () {
    var tmpStatus = "";
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.js.negation_ind === "true") {
<span class="cstat-no" title="statement not covered" >        tmpStatus = "refused";</span>
