...
<html lang="en">
<head>
    <title>Code coverage report for blue-button/lib/parser/c32/sections/allergies.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">blue-button/lib/parser/c32/sections/allergies.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">blue-button/lib/parser/c32/sections/</a> &#187; allergies.js</div>
</div>
<div class="body">
...
&nbsp;
        //Custom VA C32 Shim.
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js.code) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.js.code.js.name === "Coded Allergy Name Not Available") {
                delete this.js.code;
            }
        }
&nbsp;
